...
UUID=${UUID:-'97a8b422-0a03-4c2c-82b8-9c850fecb79e'}
VMESS_WSPATH=${VMESS_WSPATH:-'/Z5QsJjxsl9YLkEqx'}
VLESS_WSPATH=${VLESS_WSPATH:-'/8YChO8YWLJuJXA'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/XGVGzN6Kgwo'}
SS_WSPATH=${SS_WSPATH:-'/5caHl'}
